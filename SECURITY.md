...
- Malicious content injected into agent/skill markdown (prompt injection)

## Reporting a Vulnerability

If you discover a security issue, please report it through
[GitHub's private vulnerability reporting](https://github.com/aliasunder/agent-plugins/security/advisories/new)
